...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getWithRestaurants() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + ADMIN_ID + "/with-restaurants"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_WITH_RESRAURANTS_MATCHER.contentJson(admin));
    }
    ...
    void createDuplicate() throws Exception {
        User expected = new User(null, "New", USER_MAIL, "newPass", null, Role.USER, Role.ADMIN);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
