...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getWithRestaurants() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL_SLASH + UserTestData.ADMIN_ID + "/with-restaurants"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(UserTestData.USER_WITH_RESRAURANTS_MATCHER.contentJson(UserTestData.admin));
    }

    @Test
    @WithUserDetails(value = UserTestData.ADMIN_MAIL)
    void createInvalid() throws Exception {
        User invalid = new User(null, null, "", "newPass", null, Role.USER, Role.ADMIN);
    ...
    void createDuplicate() throws Exception {
        User expected = new User(null, "New", UserTestData.USER_MAIL, "newPass", null, Role.USER, Role.ADMIN);
        perform(MockMvcRequestBuilders.post(AdminUserController.REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
